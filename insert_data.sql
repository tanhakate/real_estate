...
INSERT INTO `House` (`id`, `house_name`, `office_id`, `agent_id`, `seller_id`, `num_bedrooms`, `num_bathrooms`, `listing_price`, `listing_date`, `zipcode`, `sold`) VALUES
(1, 11, 1, 7, 1, 3, 4, 100000, '2019-03-01', 94103, 0),
(2, 22, 2, 7, 3, 2, 3, 90000, '2020-01-02', 94111, 1),
(3, 33, 3, 6, 4, 3, 4, 210000, '2019-01-02', 46082, 1),
(4, 44, 4, 5, 2, 2, 4, 600000, '2020-02-02', 1233, 1),
(5, 55, 5, 4, 6, 8, 6, 2000000, '2019-12-02', 11312, 1),
(6, 66, 6, 3, 5, 5, 6, 85000, '2019-09-02', 1001, 1),
(7, 77, 7, 2, 8, 3, 6, 500000, '2020-01-03', 2140, 1),
(8, 88, 8, 1, 7, 5, 6, 600000, '2020-01-02', 412109, 1),
(9, 99, 9, 7, 10, 1, 6, 2000000, '2020-01-02', 734107, 0),
(10, 111, 5, 6, 6, 3, 2, 110000, '2020-01-02', 11312, 1),
(11, 222, 2, 5, 3, 4, 7, 700000, '2020-01-02', 94111, 1),
(12, 333, 3, 4, 4, 2, 2, 990000, '2020-01-02', 46082, 1),
(13, 444, 6, 3, 5, 4, 2, 2200000, '2020-01-02', 1001, 0),
(14, 555, 5, 2, 6, 1, 1, 60000, '2020-01-02', 11313, 1);
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 2;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(16, 3, 11, 6, 178099, '2020-03-06');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 3;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(17, 4, 13, 5, 378099, '2020-03-07');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 4;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(18, 5, 12, 4, 378099, '2020-03-08');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 5;
COMMIT;
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 6;
COMMIT;
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 7;
COMMIT;
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 8;
COMMIT;
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 9;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(23, 10, 12, 6, 390099, '2020-03-16');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 10;
COMMIT;
...
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 12;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(26, 13, 16, 3, 990099, '2020-03-19');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 13;
COMMIT;

START TRANSACTION;
INSERT INTO `sale` (`id`, `house_id`, `buyer_id`, `agent_id`, `sale_price`, `sale_date`) VALUES
(27, 14, 13, 2, 3990099, '2020-03-19');
UPDATE `House` SET `sold` = '1' WHERE `House`.`id` = 14;
COMMIT;
-- --------------------------------------------------------
